...
**Status:** Implemented — portal Phases 0–8; **S1 Identity & Access admin UI sign-off complete**; **S3 hospitality UI Phases 1–7 complete** (`scripts/portal-hospitality-smoke.ps1`)  
...
| **S3 hospitality polish** | 7 sub-phases in `s3-phases.yaml` | Front desk hub → back-office master data — **complete** |
