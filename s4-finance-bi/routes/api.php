...
Route::middleware('jwt')->group(function () {
    ...
    Route::put('/fiscal-periods/{fiscalPeriod}/close', [FiscalPeriodController::class, 'close'])
        ->middleware('permission:S4.finance.fiscal_periods.close');
    ...
    Route::put('/fiscal-periods/{fiscalPeriod}/lock', [FiscalPeriodController::class, 'lock'])
        ->middleware('permission:S4.finance.fiscal_periods.lock');
    ...
    Route::put('/journal-entries/{journalEntry}/approve', [JournalController::class, 'approve'])
        ->middleware('permission:S4.finance.journal_entries.approve');
    ...
    Route::delete('/journal-entries/{journalEntry}', [JournalController::class, 'destroy'])
        ->middleware('permission:S4.finance.journal_entries.create');
    ...
    Route::get('/reports/cash-flow', [ReportController::class, 'cashFlow'])
        ->middleware('permission:S4.finance.reports.read');
    Route::get('/reports/departmental', [ReportController::class, 'departmental'])
        ->middleware('permission:S4.finance.reports.read');
    ...
    Route::get('/dashboard/executive', [DashboardController::class, 'executive'])
        ->middleware('permission:S4.bi.dashboards.read');
    Route::get('/dashboard/hotel', [DashboardController::class, 'hotel'])
        ->middleware('permission:S4.bi.dashboards.read');
